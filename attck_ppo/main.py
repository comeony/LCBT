...
parser.add_argument('--max_training_epochs', default=100000, type=int, help='')
...
parser.add_argument('--describe', default="PPO black attack ControlSlideEnv", )
...
if args.ATTACK:
    ...
    attack_target_model = args.attack_target_model + args.env_name + "/target_model.pth"
