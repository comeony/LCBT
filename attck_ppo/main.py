...
parser.add_argument('--env_name', default='CarFindFlagMEnv', type=str, help='environment(ControlSlideEnv CarFindFlagMEnv)')
...
parser.add_argument('--delta', default=0.95, type=float)
...
if args.ATTACK:
    ...
    attack_target_model = args.attack_target_model + args.env_name + "/targetm_model.pth"
